    ...
    <div className='lg:flex lg:mx-[170px] md:mx-[50px] md:block md:mb-[50px]'>
      <div className='flex gap-[17px]'>
        <div className='flex flex-col gap-[16px]'>
            <img src={product.image} className='h-[163px] w-[550px] md:w-[80px]'/>
            <img src={product.image} className='h-[163px] w-[550px] md:w-[80px]'/>
            <img src={product.image} className='h-[163px] w-[550px] md:w-[80px]'/>
            <img src={product.image} className='h-[163px] w-[550px] md:w-[80px]'/>
        </div>
        <div>
            <img src={product.image} className='w-[596px] h-[700px] md:w-[700px]'/>
        </div>
      </div>
      <div className='mx-[70px] md:mt-[50px]'>  
        <h1 className='text-[#3d3d3d] text-[40px] font-[700]'>{product.title}</h1>
        ...
        <div className=''>
          <div className='text-[#818181] line-through'>${product.rating.count}</div>
